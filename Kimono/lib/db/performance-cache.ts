...
export const CREATOR_SNAPSHOT_TTL_MS = TTL.creator.index;
export const POPULAR_SNAPSHOT_TTL_MS = TTL.post.popular;
export const SERVER_POST_CACHE_TTL_MS = TTL.post.standard;
export const BROWSER_POST_CACHE_TTL_MS = TTL.creator.syncInterval;
