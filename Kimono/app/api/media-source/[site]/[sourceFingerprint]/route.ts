...
export async function GET(
  request: NextRequest,
  context: { params: Promise<{ site?: string; sourceFingerprint?: string }> }
) {
  const { site, sourceFingerprint } = await context.params;
  if (!site || (site !== "kemono" && site !== "coomer") || !sourceFingerprint) {
